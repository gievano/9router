...
// Proxy-pool fitness is a 0.91 feature absent from this line; the shim is a
// fail-open no-op so the limited_ip cooldown path degrades to a local
// cooldown instead of crashing the request.
import { markPoolUnfit, clearPoolUnfit } from "../services/proxyPoolFitnessShim.js";
 ...
 * codebuff openai-compatible provider) builds `providerOptions.codebuff` = { codebuff_metadata, provider } and the provider spreads those entries at the TOP LEVEL of the request body — i.e. the body is:
...
const FB_STATE_KEY = "__9router_freebuff_state__";
